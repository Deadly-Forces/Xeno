  ...
  return <div className="space-y-5 pb-24">
    ...
    {!plan ? <section className="grid gap-4 md:grid-cols-3">{[
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">{[
        ...
        ["Estimated cost", `$${plan.estimates.cost.toFixed(2)}`, `$${budget.toFixed(0)} ceiling`],
        ...
        <div className="p-5 md:p-6">
          {tab === "Approval" && <div className="grid gap-6 xl:grid-cols-[1.2fr_1fr]">
            ...
            <div className="space-y-4">
              ...
              {!plan.estimates.withinBudget && <p className="flex gap-2 rounded-md bg-red-50 p-3 text-sm text-red-700"><AlertTriangle className="shrink-0" size={17} />Projected cost exceeds the extracted budget. Raise the ceiling or narrow the audience.</p>}
            </div>
          </div>}
